<!-- <main id="main" class="w-full h-full relative bg-gray-600 p-2">
    <div id="page"  class="w-screen h-screen sticky top-0  bg-orange-400    ">
        <div class="absolute bg-black h-44 w-44 top-0 ">hello</div>
    </div>
    <div id="page1" class="h-screen w-screen bg-blue-300 relative z-20"></div>
    <div id="page2" class="h-screen w-screen bg-red-700 relative z-20"></div>
    <div id="page3" class="h-screen w-screen bg-black relative z-20"></div>
</main> -->
<script>
...
<main id="main" class="relative ">
    <div id="page" class="  relative w-screen">
        <canvas></canvas>
        <div class="h-screen absolute top-0 left-0">
            <div class="h-screen w-full text-center text-5xl ">hello</div>
            <div class="h-screen w-full text-center text-5xl ">ram</div>
        </div>
    </div>
